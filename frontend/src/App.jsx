...
function App() {
  ...
  const pipelineStatus = isLoading ? 'processing' : error ? 'error' : results ? 'complete' : 'idle';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <p className="mt-3 text-sm text-gray-500">Supports PDF, JPG, PNG (max 10MB)</p>
            ...
            {results && currentFile && (
              ...
              <DocumentPreview file={currentFile} entities={results?.pages?.[0]?.entities || {}} />
                ...
                <div className="mt-4">
                  ...
                  {results.partial && (
                    <p className="text-yellow-600 mt-2">Only first 3 pages processed</p>
                  )}
                </div>
              </div>
            )}
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {results && (
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <ResultsDisplay data={results} viewMode={viewMode} />
              </div>
            )}
          </div>
        </div>
