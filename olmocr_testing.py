...
image_base64 = render_pdf_to_base64png(r"Courses.pdf", 1, target_longest_image_dim=1024)

# Build the prompt, using document metadata
anchor_text = get_anchor_text(r"Courses.pdf", 1, pdf_engine="pdfreport", target_length=4000)
